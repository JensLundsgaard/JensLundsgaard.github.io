export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center px-6 gap-3">
      <div className="max-w-4xl text-center">
        <h1 className="text-6xl font-bold text-white mb-4 p-10 m-10">Jens Lundsgaard</h1>
        ...
        <div className="flex gap-6 justify-center text-zinc-400">
          ...
          <span>•</span>
          <a href="https://www.linkedin.com/in/jens-lundsgaard-13700625b/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
            LinkedIn
          </a>
          <span>•</span>
